...
/**
 * 与服务端 MessageSendDto 保持包名、类名、serialVersionUID完全一致，
 * 确保Redisson默认编解码器(MarshallingCodec)能正确序列化/反序列化。
 */
public class MessageSendDto<T> implements Serializable {
    ...
    public void setExtendData(T extendData) { this.extendData = extendData; }
