...
public class BenchmarkMain {
    ...
    private static void printUsage() {
        System.out.println("MyChat Benchmark Tool");
        System.out.println("=======================");
        System.out.println();
        ...
        System.out.println("  --redis-url <url>       Redis地址 (默认 redis://localhost:6379)");
        System.out.println("  --db-url <url>          MySQL JDBC地址 (默认 jdbc:mysql://127.0.0.1:3306/mychat)");
        System.out.println("  --db-user <user>        MySQL用户名 (默认 root)");
        System.out.println("  --db-password <pwd>     MySQL密码 (默认 root，或读环境变量 MYSQL_PASSWORD)");
