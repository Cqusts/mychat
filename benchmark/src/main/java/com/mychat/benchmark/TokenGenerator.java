...
public class TokenGenerator {
    ...
    private static final String REDIS_KEY_WS_TOKEN = "mychat:ws:token:";
    private static final String REDIS_KEY_WS_TOKEN_USERID = "mychat:ws:token:userid:";
    ...
    public static void run(String[] args) throws Exception {
        ...
        String dbUrl = p.get("db-url", "jdbc:mysql://127.0.0.1:3306/mychat?useUnicode=true&characterEncoding=utf8");
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(output))) {
            for (int i = 0; i < count; i++) {
                ...
                String tokenJson = String.format(
                    "{\"@class\":\"com.mychat.entity.dto.TokenUserInfoDto\","
